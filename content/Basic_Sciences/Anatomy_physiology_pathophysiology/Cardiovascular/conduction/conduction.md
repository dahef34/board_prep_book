...
- {{% badge color="grey" icon="question-circle" title="1. " %}}Symptomatic bradycardia{{% /badge %}}  
- {{% badge color="grey" icon="question-circle" title="2. " %}}3° AV block{{% /badge %}}  
- {{% badge color="grey" icon="question-circle" title="3. " %}}Alternating bundle branch block{{% /badge %}}  
- {{% badge color="grey" icon="question-circle" title="4. " %}}Ventricular tachycardia{{% /badge %}}
